...
path3 = 1.5.*[0.0 0.0 0.0 ; ...
        ...
        4.0 -2.0 0.0 ; ...
        4.0 0.0 1.0 ; ...
        4.0 0.0 2.0; ]; % Figure U with dense points

path4 = 0.5.*[0.0 0.0 0.0 ; ...
        5.0 10.0 5.0 ; ...
        10.0 0.0 0.0 ; ...
        2.5 5.0 5.0 ; ...
        7.5 6.0 0.0]; % Figure S with less points

path5 = 0.8.*[0.0 0.0 0.0 ; ...
        5.0 -10.0 5.0 ; ...
        10.0 0.0 0.0 ;]; % Figure S with less points
...
switch 5 % Enter the number of the path you want to test (1-5)
        case 1
